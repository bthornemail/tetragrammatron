...
| `DBC-TEST-MATRIX` | Test definitions for all six test classes (Golden, Negative, Extension, Adapter, Integration, Replay) | Conformance test authors, CI |
...
**Device / IoT integrator:** HD-RPC-1.0 §8 → HD-RPC-1.0-DEPLOYMENT (device section) → HD-RPC-1.0-SEMANTIC-ROUTING

**End-user client author:** DBC-IDL-1.2 §4 → DBC-NODE-1.0 §3 → HD-RPC-1.0-DEPLOYMENT (Profile D)
